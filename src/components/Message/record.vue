      ...
      <el-tabs v-model="currentTab" @tab-click="handleClick">
        <el-tab-pane label="发送记录" name="first">
          ...
          <div class="content-head">
            <div class="headerBtn">
              ...
              <el-select v-model="sendStatus" placeholder="状态" size="small" ref="statusSelect" @visible-change="statusChange" clearable>
              ...
              <el-date-picker size="small" v-model="time" type="daterange" :clearable="false" range-separator="~" format="yyyy-MM-dd" value-format="yyyy-MM-dd" start-placeholder="开始日期"
                end-placeholder="结束日期" style="position:relative;bottom:1px">
              </el-date-picker>
            </div>

            <el-button-group>
              <div class="headerBtnRight">
                <el-button size="small" class=" iconBtn active" style="margin-right:3px" @click="exportRepeat" v-has="'messageBatchMessageExport'">
          ...
          <h-table :tableOptions="tableOptions" :operation="true" :data="data" v-loading="loading1" @select="selectValues">
            ...
            <template slot="operation" slot-scope="scope">
              <el-tooltip class="item" effect="dark" content="取消发送" placement="top">
                ...
                <img class="operation" src="../../assets/images1/icon_24px_审核不能过.svg" @click="cancaleSend(scope)" v-has="'messageBatchWithdraw'">
              </el-tooltip>
              <el-tooltip class="item" effect="dark" content="发送详情" placement="top">
                ...
                <img class="operation" src="../../assets/images1/icon_24px_更多.svg" @click="toDetail(scope)" v-has="'messageSendRecordPageList'">
              </el-tooltip>
            </template>
        ...
        <el-tab-pane label="发送详情" name="second">
          <div class="headerBtn">
            ...
            <el-select v-model="enterpriseAccountAppId2" placeholder="应用" size="small" clearable ref="selectApp2" @visible-change="selectApp2">
              <el-option v-for="item in appOptions" :key="item.id" :label="item.name" :value="item.value">
              </el-option>
            </el-select>
            <el-select v-model="status2" placeholder="状态" size="small" clearable ref="statusSelect2" @visible-change="statusSelect2">
                ...
                <el-table-column label="操作">
                  <template slot-scope="scope">
                    <el-tooltip class="item" effect="dark" content="回复消息" placement="top">
                      ...
                      <img class="operation" src="../../assets/images1/icon_24px_回复.svg" @click="replyMessage(scope)" v-has="'messageReply'" />
                    </el-tooltip>
                    <el-tooltip class="item" effect="dark" content="查看记录" placement="top">
                      <!-- <el-button type="text" size="small">
                        <img src="../../assets/images1/icon_24px_详情.svg" />
                      </el-button> -->
                      <img class="operation" src="../../assets/images1/icon_24px_详情.svg" @click="handleDetails(scope.$index, scope.row)" v-has="'messageRecordView'" />
                    </el-tooltip>
                  </template>
                </el-table-column>
              </el-table>
...
export default {
  ...
  methods: {
    ...
    initData(){
      Promise.all([this.getDataList(), this.getMessageLists(), this.getChannelList(), this.getMessageTypeList()]).then(() => {
        this.getSendBatchList()
